...
const PromoBanner: React.FC<{
    ...
    onProductSelect: (product: Product) => void;
    isMainTitle?: boolean;
}> = ({ imageUrl, title, description, product, onProductSelect, isMainTitle }) => {
    const TitleTag = isMainTitle ? 'h1' : 'h2';
    return (
        <div 
            className="h-screen relative w-full flex items-center justify-center text-white text-center p-8"
        >
            <div
            ...
            <div className="relative z-10 flex flex-col items-center">
                <TitleTag className="text-4xl md:text-6xl font-bold tracking-tighter">{title}</TitleTag>
