...
const categoryTitles: { [key: string]: string } = {
    standard: "Colores Estándar",
    mixed: "Colores Mezclados y Efectos",
};
...
const VinylTab: React.FC = () => {
    ...
    return (
        <div className="bg-white text-black -mx-4 sm:-mx-6 -my-4 sm:-my-6">
            {/* Hero Section */}
            <div className="relative h-screen flex items-center justify-center text-center p-8 text-white overflow-hidden">
                ...
                <div className="relative z-10 fade-in-up max-w-4xl">
                    <h1 className="text-4xl sm:text-6xl font-bold text-white tracking-tighter">Fabricación de Vinilos</h1>
