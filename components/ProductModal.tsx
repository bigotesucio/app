...
import VinylConfigurator from './VinylConfigurator';
...
const ProductModal: React.FC<ProductModalProps> = ({ product, onClose, onImageClick }) => {
    ...
    // If the product has a specific configurator, render it instead of the default modal.
    if (product.configurator === 'vinyl') {
        return <VinylConfigurator product={product} onClose={onClose} />;
    }
